...
export const dict: Record<Locale, Dict> = {
	vi: {
		...
		'hero.tagline': 'Cuộn xuống để mở phong thư',
		'hero.tapHint': 'Bấm vào phong thư để mở thiệp',
		...
		'gratitudeEn.body':
			'Thank you, family and friends, for being part of our journey. Your love and support mean the world to us.',

		'poetry1.vi':
			'Anh đi tìm em qua bao mùa hoa nở\nMà chẳng hay em đã ở trong tim',
		'poetry1.en':
			'I searched for you through countless blooming seasons,\nnot knowing you were already in my heart.',

		'quoteThreeThings.vi':
			'Em yêu ba điều trên thế giới này\nMặt trời, mặt trăng và em.',
		'quoteThreeThings.en':
		...
		'sentiment1.body':
			'Em là điều đẹp đẽ nhất mà cuộc đời này đã trao cho anh. Cảm ơn vì em đã đến và đã ở lại.',
		...
		'poetry2.verse1.en':
			'We only truly love once in a lifetime\n— and I have chosen you.',
		'poetry2.verse2.vi': 'Cảm ơn em đã đến\nĐể anh có một mái nhà.',
		'poetry2.verse2.en': 'Thank you for arriving — for giving me a home.',

		'dateDetails.dayOfWeek': 'Chủ nhật',
		'dateDetails.solar': '08/11/2026',
		'dateDetails.lunarPrefix': 'Nhằm ngày',
		'dateDetails.timePrefix': 'Vào lúc',

		'calendar.monthLabel': 'Tháng 11 — November 2026',

		'closingSentiment.body':
			'Hãy cùng chúng tôi viết tiếp câu chuyện tình yêu — đẹp, giản dị, và mãi mãi.',
		...
		'rsvp.intro':
			'Sự có mặt của quý vị là niềm vinh hạnh lớn nhất của chúng tôi. Xin vui lòng xác nhận tham dự qua mẫu sau.',
	...
	en: {
		...
		'hero.tagline': 'Scroll to open the envelope',
		'hero.tapHint': 'Tap the envelope to open',
		...
		'sentiment1.body':
			'You are the most beautiful thing this life has ever given me. Thank you for arriving — and for staying.',
		...
		'dateDetails.dayOfWeek': 'Sunday',
		'dateDetails.solar': 'November 8, 2026',
		'dateDetails.lunarPrefix': 'Lunar:',
		'dateDetails.timePrefix': 'At',

		'calendar.monthLabel': 'November 2026',

		'closingSentiment.body':
			'Come write the next chapter of our love story with us — simply, beautifully, forever.',
		...
		'rsvp.intro':
			'Your presence would mean the world to us. Please confirm your attendance by completing the form.',
